...
const SolarIntelligence: React.FC = () => {
  ...
  return (
    <div className="space-y-4 md:space-y-6 animate-fade-in max-w-6xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4">
        ...
        <div className="flex items-center gap-3 bg-slate-900 border border-slate-700 p-1 rounded-lg w-full sm:w-auto">
           <select 
             className="bg-transparent text-slate-300 text-sm border-none focus:ring-0 cursor-pointer py-1 px-3 w-full sm:min-w-[200px]"
             value={leadId}
